...
ENDM
	...
	connection north, Route0, ROUTE_0, 0
	...
	map_attributes Route0, ROUTE_0, $05, SOUTH
	...
	map_attributes DarkCaveVioletEntrance, DARK_CAVE_VIOLET_ENTRANCE, $00, 0
	map_attributes DarkCaveBlackthornEntrance, DARK_CAVE_BLACKTHORN_ENTRANCE, $00, 0
