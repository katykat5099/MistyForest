...
KarenGroup:
	...
	db 42, UMBREON,    SCRATCH, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
...
CooltrainerMGroup:
	...
	db 35, FLAREON,    SCRATCH, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	db 25, PIDGEOT,    SCRATCH, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	...
	db 32, FLAREON,    SCRATCH, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	db 35, SANDSLASH,  SCRATCH, POISON_STING, SLASH, SWIFT
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, ESPEON,     SCRATCH, QUICK_ATTACK, SWIFT, PSYCHIC_M
...
HikerGroup:
	...
	db 27, DIGLETT,    MAGNITUDE, DIG, SCRATCH, SLASH
	db 27, DUGTRIO,    MAGNITUDE, DIG, SCRATCH, SLASH
	db -1 ; end
