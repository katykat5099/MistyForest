	tilepal 0, WATER, BROWN, YELLOW, YELLOW, RED, GREEN, GREEN, BROWN
	tilepal 0, BROWN, BROWN, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY
	tilepal 0, GRAY, BROWN, YELLOW, YELLOW, RED, GREEN, GREEN, BROWN
	tilepal 0, BROWN, ROOF, GRAY, GRAY, BROWN, BROWN, GRAY, GRAY
