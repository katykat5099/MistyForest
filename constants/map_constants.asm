...
; - scripts and events (see data/maps/scripts.asm)
	...
	map_const DARK_CAVE_VIOLET_ENTRANCE,                   10,  4 ; 78
	map_const DARK_CAVE_BLACKTHORN_ENTRANCE,               11, 16 ; 79
	...
	map_const ROUTE_27,                                     5,  9 ;  2
	map_const ROUTE_29,                                    30,  9 ;  3
	map_const NEW_BARK_TOWN,                               10,  9 ;  4
	map_const ELMS_LAB,                                     5,  5 ;  5
	map_const PLAYERS_HOUSE_1F,                             8,  7 ;  6
	...
	map_const CHERRYGROVE_EVOLUTION_SPEECH_HOUSE,           9,  8 ;  8
