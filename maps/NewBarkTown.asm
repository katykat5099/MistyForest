...
NewBarkTown_MapEvents:
	...
	bg_event  1,  3, BGEVENT_READ, NewBarkTownElmsLabSign
	bg_event 18, 10, BGEVENT_READ, NewBarkTownElmsHouseSign

	def_object_events
	object_event  8,  5, SPRITE_TEACHER, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, NewBarkTownTeacherScript, -1
